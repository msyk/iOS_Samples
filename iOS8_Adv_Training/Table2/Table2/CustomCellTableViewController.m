...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.column1.text = [NSString stringWithFormat:
                         @"Section%ld", (long)indexPath.section];
    cell.column2.text = [NSString stringWithFormat: @"Line%ld", (long)indexPath.row];
    cell.column3.text = [NSString stringWithFormat: @"Info%ld", (long)indexPath.row];
